...
<body x-data="{ sidebarOpen: true, showAddModal: false, showEditModal: false, }" class="bg-gray-100/50 overflow-x-hidden min-h-screen transition-colors duration-300">
