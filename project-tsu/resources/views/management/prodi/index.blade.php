...
<body class="bg-gray-100/50 overflow-x-hidden min-h-screen">
    ...
    <div class="flex min-h-screen">
        ...
        <aside id="sidebar" class="w-64 flex-shrink-0 bg-white shadow-md flex flex-col transition-all duration-300 ease-in-out fixed inset-y-0 left-0 z-30">
            ...
            <nav class="px-4 py-4 space-y-1">
                ...
                <!-- Link Prodi (Halaman Ini) -->
                <a href="{{ route('prodi.index') }}" class="flex items-center px-4 py-2 text-white bg-teal-600 rounded-lg shadow-lg">
            ...
            <div class="px-4 py-4 border-t border-gray-200">
                <a href="{{ route('jadwal.index') }}" class="flex items-center px-4 py-2 text-gray-700 rounded-lg hover:bg-gray-100">
    ...
    <!-- Memanggil komponen popup sukses -->
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // === LOGIKA MODAL BARU ===
            const modal = document.getElementById('tambah-prodi-modal');
