...
<body x-data="{ sidebarOpen: true, showExportMenu: false, isLoading: true, init() { setTimeout(() => this.isLoading = false, 2000) } }" class="bg-gray-100/50 overflow-x-hidden min-h-screen transition-colors duration-300">
        ...
        <main id="main-content" :class="sidebarOpen ? 'lg:ml-64' : ''" class="flex-1 min-w-0 p-6 sm:p-10 transition-all duration-300 ease-in-out ml-0 bg-gray-50 flex flex-col">
                 ...
                 <div class="flex items-center space-x-2">
                     ...
                     <div class="relative" @click.away="showExportMenu = false">
                         ...
                         <div x-show="showExportMenu" 
                              ...
                              style="display: none;">
                             <a href="{{ route('mahasiswa.export.excel') }}" class="flex items-center px-4 py-2.5 text-sm text-gray-700 rounded-md hover:bg-teal-50 hover:text-teal-800 transition-colors">
                             ...
                             <a href="{{ route('mahasiswa.export.pdf') }}" class="flex items-center px-4 py-2.5 text-sm text-gray-700 rounded-md hover:bg-teal-50 hover:text-teal-800 transition-colors">
            ...
            <div class="flex-1 flex flex-col items-center justify-center p-4 sm:p-8 bg-white rounded-lg shadow-sm border border-gray-200">
                <div class="w-full max-w-md text-center">
                    ...
                    <p class="text-sm sm:text-base text-gray-500 mb-4 sm:mb-6 px-4">Fitur Manajemen Mahasiswa sedang dalam tahap pengembangan. Mohon kembali lagi nanti.</p>
