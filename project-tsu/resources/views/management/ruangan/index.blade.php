            ...
            <div class="flex items-center space-x-2">
                ...
                <div class="relative" @click.away="showExportMenu = false">
                    ...
                    <div x-show="showExportMenu" 
                         ...
                         style="display: none;">
                        <a href="{{ route('ruangan.export.excel') }}" class="flex items-center px-4 py-2.5 text-sm text-gray-700 rounded-md hover:bg-teal-50 hover:text-teal-800 transition-colors">
                        ...
                        <a href="{{ route('ruangan.export.pdf') }}" class="flex items-center px-4 py-2.5 text-sm text-gray-700 rounded-md hover:bg-teal-50 hover:text-teal-800 transition-colors">
