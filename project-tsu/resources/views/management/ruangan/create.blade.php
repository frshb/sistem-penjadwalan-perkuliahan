...
<body class="bg-gray-100/50 overflow-x-hidden">
        ...
        <div class="flex items-center">
             <h1 class="text-2xl font-bold text-gray-800 ml-3">Tambah Ruangan Baru</h1>
        </div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <select name="tipe_ruangan" id="tipe_ruangan"
                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-teal-500 focus:border-teal-500 sm:text-sm" required>
                            <option value="reguler" {{ old('tipe_ruangan') == 'reguler' ? 'selected' : '' }}>Reguler (Teori)</option>
                            <option value="lab" {{ old('tipe_ruangan') == 'lab' ? 'selected' : '' }}>Lab (Praktikum)</option>
                            <option value="studio" {{ old('tipe_ruangan') == 'studio' ? 'selected' : '' }}>Studio</option>
                            <option value="hybrid" {{ old('tipe_ruangan') == 'hybrid' ? 'selected' : '' }}>Hybrid</option>
                        </select>
                    </div>
