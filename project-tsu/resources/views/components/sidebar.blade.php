...
<aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" 
    ...
    <div class="px-4 py-4 border-t border-gray-200">
        <a href="{{ route('penjadwalan.index') }}" class="flex items-center {{ request()->routeIs('jadwal.index') ? 'px-4 py-2 text-white bg-teal-600 shadow-lg' : 'px-4 py-2 text-gray-700 rounded-lg hover:bg-gray-100' }}">
