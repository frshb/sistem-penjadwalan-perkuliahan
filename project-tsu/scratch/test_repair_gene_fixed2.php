...
echo "Is Room 17 occupied at Day 1 Slot 7? " . (isset($lockedRuang[17][1][7]) ? "YES" : "NO") . "\n";
echo "Is Dosen " . $info['id_dosen'] . " occupied at Day 1 Slot 7? " . (isset($lockedDosen[$info['id_dosen']][1][7]) ? "YES" : "NO") . "\n";
